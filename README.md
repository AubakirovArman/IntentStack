...
`migrate`, `list_capabilities`, `schema`, `graph`, `openapi`, `testgen`, `deploy`, `stats`, `verify`; two target adapters;
...
webhook dispatch; generated health/metrics endpoints; generated API contract tests; deploy config generation; GitHub Actions CI for compiler lint/tests, Rust wrapper tests, and generated app build matrix.
