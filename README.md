...
webhook dispatch; generated API contract tests; deploy config generation; GitHub Actions CI for compiler lint/tests, Rust wrapper tests, and generated app build matrix.
