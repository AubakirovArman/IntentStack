      ...
      <div className="max-w-6xl mx-auto px-4 grid gap-10 lg:grid-cols-[220px_minmax(0,1fr)]">
        <aside className="hidden lg:block">
          <nav className="sticky top-24 rounded-lg border bg-card p-4 text-sm">
            ...
            <a className="ml-3 block py-1 text-muted-foreground transition-colors hover:text-foreground" href="#cards-example">{"Card grid"}</a>
            <a className="ml-3 block py-1 text-muted-foreground transition-colors hover:text-foreground" href="#form-example">{"Form"}</a>
            <a className="ml-3 block py-1 text-muted-foreground transition-colors hover:text-foreground" href="#table-example">{"Table"}</a>
            <a className="ml-3 block py-1 text-muted-foreground transition-colors hover:text-foreground" href="#pricing-example">{"Pricing cards"}</a>
            <a className="ml-3 block py-1 text-muted-foreground transition-colors hover:text-foreground" href="#stats-example">{"Stats"}</a>
        ...
        <article className="space-y-6">
          ...
          <div id="cards-example" className="overflow-hidden rounded-lg border bg-card shadow-sm">
            <div className="space-y-2 border-b p-4">
            <h3 className="text-xl font-semibold">{"Card grid"}</h3>
            <p className="text-base leading-7 text-muted-foreground">{"A card_grid section is useful for feature cards, service lists, galleries, and compact repeated content. The preview is generated from the section module; the patch below shows how to create the same kind of module."}</p>
            </div>
          ...
          <div id="form-example" className="overflow-hidden rounded-lg border bg-card shadow-sm">
            <div className="space-y-2 border-b p-4">
            <h3 className="text-xl font-semibold">{"Form"}</h3>
            <p className="text-base leading-7 text-muted-foreground">{"A form usually needs an entity and a create_record action. The compiler then generates the UI, request handler, validation schema, database insert, and API client."}</p>
            </div>
            <div className="bg-muted/30 [&_section]:py-8 [&_section_.max-w-6xl]:max-w-none">
              <DocsComponentForm />
            </div>
          ...
          <div id="table-example" className="overflow-hidden rounded-lg border bg-card shadow-sm">
            <div className="space-y-2 border-b p-4">
            <h3 className="text-xl font-semibold">{"Table"}</h3>
            <p className="text-base leading-7 text-muted-foreground">{"A table connects to a list_records action. The generated app owns loading, empty, and error states while the intent declares the entity, source action, and visible columns."}</p>
            </div>
            <div className="bg-muted/30 [&_section]:py-8 [&_section_.max-w-6xl]:max-w-none">
              <DocsComponentTable />
            </div>
          ...
          <div id="pricing-example" className="overflow-hidden rounded-lg border bg-card shadow-sm">
            <div className="space-y-2 border-b p-4">
            <h3 className="text-xl font-semibold">{"Pricing cards"}</h3>
            <p className="text-base leading-7 text-muted-foreground">{"pricing_cards is a structured marketing section. Plans, prices, and features stay editable as data while each target controls presentation."}</p>
            </div>
            <div className="bg-muted/30 [&_section]:py-8 [&_section_.max-w-6xl]:max-w-none">
          ...
          <div id="stats-example" className="overflow-hidden rounded-lg border bg-card shadow-sm">
            <div className="space-y-2 border-b p-4">
            <h3 className="text-xl font-semibold">{"Stats"}</h3>
            <p className="text-base leading-7 text-muted-foreground">{"stats works well for product metrics, delivery promises, usage numbers, and operational summaries. Keep each stat as data so future patches can update one value safely."}</p>
            </div>
            <div className="bg-muted/30 [&_section]:py-8 [&_section_.max-w-6xl]:max-w-none">
              <DocsComponentStats />
            </div>
